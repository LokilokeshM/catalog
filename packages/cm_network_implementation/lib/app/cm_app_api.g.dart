...
class _CMAppApis implements CMAppApis {
  _CMAppApis(
    this._dio, {
    this.baseUrl,
  });
  ...
  @override
  Future<HttpResponse<ProductListResponse>> getProductDetails() async {
    const _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
  ...
  Future<HttpResponse<ProductCollectsList>> getCollectsListDetails(
    ...
    final _data = <String, dynamic>{};
    final _result = await _dio.fetch<Map<String, dynamic>>(
        _setStreamType<HttpResponse<ProductCollectsList>>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
  ...
  Future<HttpResponse<ProductImageList>> getProductImageList(productId) async {
    ...
    final _data = <String, dynamic>{};
    final _result = await _dio.fetch<Map<String, dynamic>>(
        _setStreamType<HttpResponse<ProductImageList>>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
  ...
  @override
  Future<HttpResponse<Product>> addProduct(addProductRequest) async {
    const _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
  ...
  Future<HttpResponse<OrderList>> getOrderListStatus({status = "any"}) async {
    ...
    final _data = <String, dynamic>{};
    final _result = await _dio.fetch<Map<String, dynamic>>(
        _setStreamType<HttpResponse<OrderList>>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
  ...
  Future<HttpResponse<CountEntity>> getCustomerCount() async {
    ...
    final _data = <String, dynamic>{};
    final _result = await _dio.fetch<Map<String, dynamic>>(
        _setStreamType<HttpResponse<CountEntity>>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
  ...
  @override
  Future<HttpResponse<ProductListResponse>> getProductListStatus(status) async {
    const _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{r'status': status};
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
