...
import 'package:cm_common/widget/button/custom_button.dart';
import 'package:cm_network_implementation/entity/product_list_response.dart';
import 'package:flutter/material.dart';
import 'package:cm_common/widget/forms/simple_input_form.dart';
              ...
              child: CustomDefaultButton(
                ...
                press: () {
                  if (_formKey.currentState!.validate()) {
                    ...
                    //     product: r.Product(
                    //         title: title.text,
                    //         bodyHtml: descriptionController.text,
                    //         vendor: "",
                    //         productType: productType.text,
                    //         tags: []));
                    // if (widget.product == null) {
